        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricingTierName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CustomerEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: false),
                    BuyerSubject = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_inventory_tiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_inventory_tiers_inventory_events_EventId",
                        column: x => x.EventId,
                        principalTable: "inventory_events",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_inventory_events_StartsAtUtc",
                table: "inventory_events",
                column: "StartsAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_inventory_tiers_EventId_IsActive",
                table: "inventory_tiers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ticket_purchases_EventId_PurchasedAtUtc",
                table: "ticket_purchases",
                columns: new[] { "EventId", "PurchasedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ticket_purchases_IdempotencyKey",
                table: "ticket_purchases",
