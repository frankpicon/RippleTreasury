...
namespace Reporting.Api.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_event_sales", x => x.EventId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tier_sales", x => x.PricingTierId);
                    table.ForeignKey(
                        name: "FK_tier_sales_event_sales_EventId",
                        column: x => x.EventId,
                        principalTable: "event_sales",
